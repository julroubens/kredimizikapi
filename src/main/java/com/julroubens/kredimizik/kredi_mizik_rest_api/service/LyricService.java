...
import com.julroubens.kredimizik.kredi_mizik_rest_api.domain.Language;
import com.julroubens.kredimizik.kredi_mizik_rest_api.domain.Lyric;
...
import com.julroubens.kredimizik.kredi_mizik_rest_api.repos.LanguageRepository;
import com.julroubens.kredimizik.kredi_mizik_rest_api.repos.LyricRepository;
...
public class LyricService {
    ...
    private LyricDTO mapToDTO(final Lyric lyric, final LyricDTO lyricDTO) {
        ...
        lyricDTO.setImageUrl(lyric.getImageUrl());
    ...
    private Lyric mapToEntity(final LyricDTO lyricDTO, final Lyric lyric) {
        ...
        lyric.setImageUrl(lyricDTO.getImageUrl());
