...
import com.julroubens.kredimizik.kredi_mizik_rest_api.service.EntityTypeService;
...
public class EntityTypeResource {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Long> updateEntityType(@PathVariable(name = "id") final Long id,
            @RequestBody @Valid final EntityTypeDTO entityTypeDTO) {
