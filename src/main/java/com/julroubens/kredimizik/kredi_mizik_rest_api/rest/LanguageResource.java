...
import com.julroubens.kredimizik.kredi_mizik_rest_api.model.LanguageDTO;
import com.julroubens.kredimizik.kredi_mizik_rest_api.service.LanguageService;
...
public class LanguageResource {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Long> updateLanguage(@PathVariable(name = "id") final Long id,
