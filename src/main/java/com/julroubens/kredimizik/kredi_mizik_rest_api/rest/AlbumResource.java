...
import com.julroubens.kredimizik.kredi_mizik_rest_api.model.AlbumDTO;
import com.julroubens.kredimizik.kredi_mizik_rest_api.service.AlbumService;
...
public class AlbumResource {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Long> updateAlbum(@PathVariable(name = "id") final Long id,
