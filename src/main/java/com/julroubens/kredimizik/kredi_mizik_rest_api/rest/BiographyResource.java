...
import com.julroubens.kredimizik.kredi_mizik_rest_api.model.BiographyDTO;
import com.julroubens.kredimizik.kredi_mizik_rest_api.service.BiographyService;
...
public class BiographyResource {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<Long> updateBiography(@PathVariable(name = "id") final Long id,
            @RequestBody @Valid final BiographyDTO biographyDTO) {
